<?php 
    ...
    if(!empty($_POST)){
        ...
        if($isSuccess){
            ...
            $statement = $db->prepare("UPDATE hotel SET Nom=?,Email=?,Ville=?,Adresse=?,KakaoTalk=?,Telephone=?,Etoile=?,Banque=?,NumeroCompte=?,Commentaire=?,Gym=?,Piscine=?,Restaurant=?,Parking=?,Wifi=?,Shuttle=?,Reception=?,Anglais=? WHERE ID=?");
            $statement->execute(array($name,$email,$ville,$adresse,$kakaotalk,$telephone,$etoile,$banque,$numerocompte,$commentaire,$gym,$piscine,$restaurant,$parking,$wifi,$shuttle,$reception,$anglais,$id));
            Database::disconnect();
...
<body>
    ...
    <div class="container-fluid text-center">
        ...
        <div class="row text-center">
            ...
            <section class="col-6">
                <form action="<?php echo 'hotelsupdate.php?id=' . $id ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="search" name="ville" id="ville">
                            <option value="<?php echo $item['Ville'] ?>"><?php echo $item['Ville'] ?></option>;
                    ...
                    <div class="form-group">
                        ...
                        <input id="search" type="text" id="etoile" name="etoile" placeholder="Etoile"
                            value="<?php echo $etoile ?>"><br>
            ...
            <section class="col-6">
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="gym" id="gym">
                        <option value="<?php echo $item['Gym'] ?>"><?php echo $item['Gym'] ?></option>;
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="piscine" id="piscine">
                        <option value="<?php echo $item['Piscine'] ?>"><?php echo $item['Piscine'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="restaurant" id="restaurant">
                        <option value="<?php echo $item['Restaurant'] ?>"><?php echo $item['Restaurant'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="wifi" id="wifi">
                        <option value="<?php echo $item['Wifi'] ?>"><?php echo $item['Wifi'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="shuttle" id="shuttle">
                        <option value="<?php echo $item['Shuttle'] ?>"><?php echo $item['Shuttle'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="reception" id="reception">
                        <option value="<?php echo $item['Reception'] ?>"><?php echo $item['Reception'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
                ...
                <div class="form-group">
                    ...
                    <select id="search" name="anglais" id="anglais">
                        <option value="<?php echo $item['Anglais'] ?>"><?php echo $item['Anglais'] ?></option>;
                        <option value="OUI">OUI</option>;
                        <option value="NON">NON</option>;
                    </select><br>
