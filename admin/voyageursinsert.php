<?php   
    ...
    if(!empty($_POST)){
        ...
        if($isSuccess){
            ...
            $statement = $db->prepare("INSERT INTO voyageurs (Nom,Prenom,Sexe,Age,Email,WhatsApp,Telephone,Adresse,Commentaire,Passeport,Banque,NumeroCompte) values(?,?,?,?,?,?,?,?,?,?,?,?)");
            $statement->execute(array($name,$surname,$sexe,$age,$email,$whatsapp,$telephone,$adresse,$commentaire,$passeport,$banque,$numerocompte));
            Database::disconnect();
...
<body>
    ...
    <div class="container-fluid text-center">
        <h1>Nouveau Voyageur</h1>
        <br><br>
        <div class="row text-center">

            <section class="col-6">
                <form action="voyageursinsert.php" method="POST">
